...
local presetThemes = {
	-- NEW MODERN THEMES (Retail-Inspired)
	moderndark = { "Modern Dark (Retail-Inspired)", "inlineColors{link{100,180,255,255}link2{150,200,255,255}category{255,209,0,255}category2{255,180,50,255}}textColors{iconRegion{enabled{255,255,255,1}}title{enabled{255,209,0,1}}label{enabled{200,200,200,1}disabled{110,110,110,1}}text{enabled{255,255,255,1}disabled{130,130,130,1}}link{enabled{100,180,255,1}}}fontSizes{normal{14}medium{12}small{11}}edgeSize{1}frameColors{frameBG{backdrop{15,15,15,0.95}border{40,40,40,1}}content{backdrop{28,28,28,1}border{50,50,50,0.3}}frame{backdrop{20,20,20,1}border{60,60,60,0.4}}}" },
	classic = { "Classic TSM (Green Theme)", "inlineColors{link{153,255,255,1}link2{153,255,255,1}category{36,106,36,1}category2{85,180,8,1}}textColors{iconRegion{enabled{249,255,247,1}}title{enabled{132,219,9,1}}label{enabled{216,225,211,1}disabled{150,148,140,1}}text{enabled{255,254,250,1}disabled{147,151,139,1}}link{enabled{49,56,133,1}}}fontSizes{normal{15}medium{13}small{12}}edgeSize{1.5}frameColors{frameBG{backdrop{24,24,24,0.93}border{30,30,30,1}}content{backdrop{42,42,42,1}border{0,0,0,0}}frame{backdrop{24,24,24,1}border{255,255,255,0.03}}}" },
	highcontrast = { "High Contrast (Maximum Visibility)", "inlineColors{link{100,200,255,255}link2{150,220,255,255}category{255,255,0,255}category2{255,220,100,255}}textColors{iconRegion{enabled{255,255,255,1}}title{enabled{255,255,0,1}}label{enabled{240,240,240,1}disabled{90,90,90,1}}text{enabled{255,255,255,1}disabled{100,100,100,1}}link{enabled{100,200,255,1}}}fontSizes{normal{15}medium{13}small{12}}edgeSize{2}frameColors{frameBG{backdrop{0,0,0,0.98}border{255,255,255,1}}content{backdrop{20,20,20,1}border{150,150,150,0.6}}frame{backdrop{10,10,10,1}border{200,200,200,0.8}}}" },
	-- ORIGINAL THEMES
...
local defaultTheme = presetThemes.moderndark  -- Changed to modern dark theme by default
